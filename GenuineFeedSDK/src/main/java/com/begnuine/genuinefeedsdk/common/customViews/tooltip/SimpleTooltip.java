...
public class SimpleTooltip implements PopupWindow.OnDismissListener {
    ...
    private static final int mCustomTextAppearanceRes = R.style.simpletooltip_custom;
    private static final int mDefaultBackgroundColorRes = R.color.colorBlack;
    private static final int mDefaultTextColorRes = R.color.colorWhite;
    private static final int mDefaultArrowColorRes = R.color.colorBlack;
    ...
    private final float hMargin;
    private final float mArrowMargin;
    private final float mArrowLeftMargin;
    private final float mArrowRightMargin;
    ...
    private SimpleTooltip(Builder builder) {
        ...
        hMargin = builder.horizontalMargin;
        mArrowMargin = builder.arrowMargin;
        mArrowLeftMargin = builder.arrowLeftMargin;
        mArrowRightMargin = builder.arrowRightMargin;
    ...
    private void configPopupWindow() {
        ...
        // mPopupWindow.showAtLocation(mAnchorView,mGravity,20,2);
        ...
        mRootView.post(new Runnable() {
            ...
            public void run() {
                if (mRootView.isShown())
                    ...
                    Utility.showLog("Tooltip cannot be shown, root view is invalid or has been closed.", "");
            }
        });
    }
    ...
    private PointF calculatePopupLocation() {
        ...
        switch (mGravity) {
            ...
            case Gravity.END:
                ...
                break;
            case Gravity.TOP:
               /* if(mArrowLeftMargin == 0){
                    location.x = anchorRect.right - mPopupWindow.getContentView().getWidth();
                } else{
                    location.x = anchorRect.right - mArrowLeftMargin;
                }*/
                if (mArrowLeftMargin == 0) {
                    location.x = anchorRect.left - mPopupWindow.getContentView().getWidth();
                } else {
    ...
    private void configContentView() {
        ...
        if (mShowArrow) {
            ...
            if (mArrowDirection == ArrowDrawable.TOP || mArrowDirection == ArrowDrawable.BOTTOM) {
                ...
                arrowLayoutParams.setMargins(0, (int) (-1 * mContext.getResources().getDimension(R.dimen.dimen_3dp)), 0, 0);
            } else {
    ...
    private final ViewTreeObserver.OnGlobalLayoutListener mArrowLayoutListener = new ViewTreeObserver.OnGlobalLayoutListener() {
        ...
        public void onGlobalLayout() {
            ...
            if (mShowArrow) {
                ...
                float x, y;
                if (mArrowDirection == ArrowDrawable.TOP || mArrowDirection == ArrowDrawable.BOTTOM) {
                    if (mArrowMargin == 0 && mArrowLeftMargin == 0 && mArrowRightMargin == 0) {
                    ...
                    } else if (mArrowMargin != 0) {
                        x = contentViewRect.width() - mArrowMargin;
                    } else if (mArrowLeftMargin != 0) {
                        x = mArrowLeftMargin - (mArrowView.getWidth() / 2f);
                    } else {
                        x = contentViewRect.width() - mArrowRightMargin - (mArrowView.getWidth() / 2f);
                    }
                    y = mArrowView.getTop();
    ...
    public static class Builder {
        ...
        private float arrowMargin = 0;
        private float arrowLeftMargin = 0;
        private float arrowRightMargin = 0;
        private boolean isCustomTextAppearance = false;
        ...
        public SimpleTooltip build() throws IllegalArgumentException {
            ...
            if (contentView == null) {
                ...
                if (isCustomTextAppearance) {
                    SimpleTooltipUtils.setTextAppearance(tv, mCustomTextAppearanceRes);
                } else {
                    SimpleTooltipUtils.setTextAppearance(tv, mDefaultTextAppearanceRes);
                }
                if (backgroundColor == context.getResources().getColor(R.color.colorWhite, null)) {
                    tv.setBackground(ContextCompat.getDrawable(context, R.drawable.tooltip_white_bg));
                } else {
                    tv.setBackground(ContextCompat.getDrawable(context, R.drawable.tooltip_bg));
                }
                tv.setTextColor(textColor);
//                tv.setLineSpacing(TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 3.0f,  context.getResources().getDisplayMetrics()), 1.0f);
                contentView = tv;
            }
            if (arrowColor == 0) {
            ...
            if (horizontalMargin < 0) {
                horizontalMargin = context.getResources().getDimension(mDefaultMarginRes);
            }
            if (padding < 0) {
        ...
        public Builder arrowMargin(@DimenRes int marginRes) {
            this.arrowMargin = context.getResources().getDimension(marginRes);
            return this;
        }

        public Builder arrowMargin(float marginRes) {
            this.arrowMargin = marginRes;
            return this;
        }

        public Builder arrowLeftMargin(@DimenRes int marginRes) {
            this.arrowLeftMargin = context.getResources().getDimension(marginRes);
            return this;
        }

        public Builder arrowLeftMargin(float marginRes) {
            this.arrowLeftMargin = marginRes;
            return this;
        }

        public Builder arrowRightMargin(@DimenRes int marginRes) {
            this.arrowRightMargin = context.getResources().getDimension(marginRes);
            return this;
        }

        public Builder arrowRightMargin(float marginRes) {
            this.arrowRightMargin = marginRes;
            return this;
        }
        ...
        public Builder isCustomTextAppearance(boolean isCustomTextAppearance) {
            this.isCustomTextAppearance = isCustomTextAppearance;
            return this;
        }
