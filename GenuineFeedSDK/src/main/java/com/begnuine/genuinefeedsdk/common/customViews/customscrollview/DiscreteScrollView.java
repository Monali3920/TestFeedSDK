...
import com.begnuine.genuinefeedsdk.common.customViews.customscrollview.util.ScrollListenerAdapter;
...
public class DiscreteScrollView extends RecyclerView {
    ...
    private Runnable notifyItemChangedRunnable = () -> notifyCurrentItemChanged();
